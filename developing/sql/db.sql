...
-- Started on 2023-08-17 22:14:02
...
--
-- TOC entry 235 (class 1259 OID 226537)
-- Name: Movement_custom_order; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."Movement_custom_order" (
    id bigint NOT NULL,
    description character varying(200),
    creation_date timestamp with time zone NOT NULL,
    status character varying(50) NOT NULL,
    product_shopping_car_id bigint NOT NULL,
    purchase_detail_id bigint NOT NULL
);


ALTER TABLE public."Movement_custom_order" OWNER TO postgres;

--
-- TOC entry 234 (class 1259 OID 226536)
-- Name: Movement_custom_order_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."Movement_custom_order_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public."Movement_custom_order_id_seq" OWNER TO postgres;

--
-- TOC entry 3571 (class 0 OID 0)
-- Dependencies: 234
-- Name: Movement_custom_order_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."Movement_custom_order_id_seq" OWNED BY public."Movement_custom_order".id;


--
-- TOC entry 237 (class 1259 OID 226544)
...
--
-- TOC entry 236 (class 1259 OID 226543)
...
--
-- TOC entry 239 (class 1259 OID 226551)
...
--
-- TOC entry 238 (class 1259 OID 226550)
...
--
-- TOC entry 243 (class 1259 OID 226565)
-- Name: Movement_product_shopping_car; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public."Movement_product_shopping_car" (
    id bigint NOT NULL,
    quantity integer NOT NULL,
    creation_date timestamp with time zone NOT NULL,
...
ALTER TABLE public."Movement_product_shopping_car" OWNER TO postgres;

--
-- TOC entry 242 (class 1259 OID 226564)
-- Name: Movement_product_shopping_car_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public."Movement_product_shopping_car_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE public."Movement_product_shopping_car_id_seq" OWNER TO postgres;

--
-- TOC entry 3574 (class 0 OID 0)
-- Dependencies: 242
-- Name: Movement_product_shopping_car_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public."Movement_product_shopping_car_id_seq" OWNED BY public."Movement_product_shopping_car".id;


--
-- TOC entry 241 (class 1259 OID 226558)
...
--
-- TOC entry 240 (class 1259 OID 226557)
...
--
-- TOC entry 245 (class 1259 OID 226620)
...
--
-- TOC entry 244 (class 1259 OID 226619)
...
--
-- TOC entry 246 (class 1259 OID 226641)
...
--
-- TOC entry 3260 (class 2604 OID 226385)
...
--
-- TOC entry 3261 (class 2604 OID 226394)
...
--
-- TOC entry 3258 (class 2604 OID 226360)
...
--
-- TOC entry 3259 (class 2604 OID 226369)
...
--
-- TOC entry 3269 (class 2604 OID 226540)
-- Name: Movement_custom_order id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Movement_custom_order" ALTER COLUMN id SET DEFAULT nextval('public."Movement_custom_order_id_seq"'::regclass);


--
-- TOC entry 3270 (class 2604 OID 226547)
...
--
-- TOC entry 3271 (class 2604 OID 226554)
...
--
-- TOC entry 3273 (class 2604 OID 226568)
-- Name: Movement_product_shopping_car id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Movement_product_shopping_car" ALTER COLUMN id SET DEFAULT nextval('public."Movement_product_shopping_car_id_seq"'::regclass);


--
-- TOC entry 3272 (class 2604 OID 226561)
...
--
-- TOC entry 3266 (class 2604 OID 226472)
...
--
-- TOC entry 3267 (class 2604 OID 226490)
...
--
-- TOC entry 3268 (class 2604 OID 226497)
...
--
-- TOC entry 3264 (class 2604 OID 226430)
...
--
-- TOC entry 3265 (class 2604 OID 226439)
...
--
-- TOC entry 3263 (class 2604 OID 226423)
...
--
-- TOC entry 3274 (class 2604 OID 226623)
...
--
-- TOC entry 3262 (class 2604 OID 226414)
...
--
-- TOC entry 3257 (class 2604 OID 226351)
...
--
-- TOC entry 3531 (class 0 OID 226382)
-- Dependencies: 216
...
--
-- TOC entry 3533 (class 0 OID 226391)
-- Dependencies: 218
...
--
-- TOC entry 3527 (class 0 OID 226357)
-- Dependencies: 212
...
--
-- TOC entry 3529 (class 0 OID 226366)
-- Dependencies: 214
...
--
-- TOC entry 3550 (class 0 OID 226537)
-- Dependencies: 235
-- Data for Name: Movement_custom_order; Type: TABLE DATA; Schema: public; Owner: postgres
--



--
-- TOC entry 3552 (class 0 OID 226544)
-- Dependencies: 237
...
--
-- TOC entry 3554 (class 0 OID 226551)
-- Dependencies: 239
...
--
-- TOC entry 3558 (class 0 OID 226565)
-- Dependencies: 243
-- Data for Name: Movement_product_shopping_car; Type: TABLE DATA; Schema: public; Owner: postgres
--



--
-- TOC entry 3556 (class 0 OID 226558)
-- Dependencies: 241
...
--
-- TOC entry 3543 (class 0 OID 226469)
-- Dependencies: 228
...
--
-- TOC entry 3544 (class 0 OID 226477)
-- Dependencies: 229
-- Data for Name: User_userprofile; Type: TABLE DATA; Schema: public; Owner: postgres
--

INSERT INTO public."User_userprofile" (password, last_login, identification, first_name, last_name, email, phone_number, point, salary, creation_date, entrance_date, inactive_date, is_active, is_staff, is_superuser, charge_id) VALUES ('pbkdf2_sha256$320000$oTIqBFFPwzyVb8pLSRbFVz$LJRA2cP6MdthcwPrIIjkaIJzT79S9o3Nl+YMN1Zr7L0=', '2023-08-16 14:58:04.801523-05', 12345151, 'Admin Kepler', 'Appe', 'admin@kepler.com', '', 0, 0, '2023-08-16 14:57:18.303094-05', '2023-08-16 14:57:18.303094-05', NULL, true, true, true, NULL);


--
-- TOC entry 3546 (class 0 OID 226487)
-- Dependencies: 231
...
--
-- TOC entry 3548 (class 0 OID 226494)
-- Dependencies: 233
...
--
-- TOC entry 3539 (class 0 OID 226427)
-- Dependencies: 224
...
--
-- TOC entry 3541 (class 0 OID 226436)
-- Dependencies: 226
...
--
-- TOC entry 3537 (class 0 OID 226420)
-- Dependencies: 222
...
--
-- TOC entry 3560 (class 0 OID 226620)
-- Dependencies: 245
...
--
-- TOC entry 3535 (class 0 OID 226411)
-- Dependencies: 220
...
--
-- TOC entry 3525 (class 0 OID 226348)
-- Dependencies: 210
...
--
-- TOC entry 3561 (class 0 OID 226641)
-- Dependencies: 246
...
-- Dependencies: 234
-- Name: Movement_custom_order_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."Movement_custom_order_id_seq"', 1, false);
...
-- Dependencies: 242
-- Name: Movement_product_shopping_car_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public."Movement_product_shopping_car_id_seq"', 1, false);
...
--
-- TOC entry 3292 (class 2606 OID 226396)
...
--
-- TOC entry 3288 (class 2606 OID 226389)
...
--
-- TOC entry 3290 (class 2606 OID 226387)
...
--
-- TOC entry 3280 (class 2606 OID 226364)
...
--
-- TOC entry 3282 (class 2606 OID 226362)
...
--
-- TOC entry 3285 (class 2606 OID 226373)
...
--
-- TOC entry 3339 (class 2606 OID 226542)
-- Name: Movement_custom_order Movement_custom_order_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Movement_custom_order"
    ADD CONSTRAINT "Movement_custom_order_pkey" PRIMARY KEY (id);


--
-- TOC entry 3343 (class 2606 OID 226549)
...
--
-- TOC entry 3346 (class 2606 OID 226556)
...
--
-- TOC entry 3353 (class 2606 OID 226570)
-- Name: Movement_product_shopping_car Movement_product_shopping_car_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Movement_product_shopping_car"
    ADD CONSTRAINT "Movement_product_shopping_car_pkey" PRIMARY KEY (id);


--
-- TOC entry 3350 (class 2606 OID 226563)
...
--
-- TOC entry 3317 (class 2606 OID 226476)
...
--
-- TOC entry 3319 (class 2606 OID 226474)
...
--
-- TOC entry 3323 (class 2606 OID 226485)
...
--
-- TOC entry 3328 (class 2606 OID 226492)
...
--
-- TOC entry 3331 (class 2606 OID 226509)
...
--
-- TOC entry 3325 (class 2606 OID 226483)
...
--
-- TOC entry 3333 (class 2606 OID 226523)
...
--
-- TOC entry 3336 (class 2606 OID 226499)
...
--
-- TOC entry 3306 (class 2606 OID 226466)
...
--
-- TOC entry 3311 (class 2606 OID 226452)
...
--
-- TOC entry 3314 (class 2606 OID 226441)
...
--
-- TOC entry 3308 (class 2606 OID 226432)
...
--
-- TOC entry 3301 (class 2606 OID 226443)
...
--
-- TOC entry 3303 (class 2606 OID 226425)
...
--
-- TOC entry 3358 (class 2606 OID 226628)
...
--
-- TOC entry 3296 (class 2606 OID 226418)
...
--
-- TOC entry 3298 (class 2606 OID 226416)
...
--
-- TOC entry 3277 (class 2606 OID 226355)
...
--
-- TOC entry 3362 (class 2606 OID 226647)
...
--
-- TOC entry 3293 (class 1259 OID 226408)
...
--
-- TOC entry 3294 (class 1259 OID 226409)
...
--
-- TOC entry 3286 (class 1259 OID 226397)
...
--
-- TOC entry 3278 (class 1259 OID 226374)
...
--
-- TOC entry 3283 (class 1259 OID 226380)
...
--
-- TOC entry 3340 (class 1259 OID 226617)
-- Name: Movement_custom_order_product_shopping_car_id_eba58c2d; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Movement_custom_order_product_shopping_car_id_eba58c2d" ON public."Movement_custom_order" USING btree (product_shopping_car_id);


--
-- TOC entry 3341 (class 1259 OID 226618)
-- Name: Movement_custom_order_purchase_detail_id_653c9faf; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Movement_custom_order_purchase_detail_id_653c9faf" ON public."Movement_custom_order" USING btree (purchase_detail_id);


--
-- TOC entry 3344 (class 1259 OID 226616)
...
--
-- TOC entry 3347 (class 1259 OID 226615)
...
--
-- TOC entry 3354 (class 1259 OID 226588)
-- Name: Movement_product_shopping_car_product_id_f5e994bc; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Movement_product_shopping_car_product_id_f5e994bc" ON public."Movement_product_shopping_car" USING btree (product_id);


--
-- TOC entry 3355 (class 1259 OID 226614)
-- Name: Movement_product_shopping_car_user_id_98450485; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "Movement_product_shopping_car_user_id_98450485" ON public."Movement_product_shopping_car" USING btree (user_id);


--
-- TOC entry 3348 (class 1259 OID 226581)
...
--
-- TOC entry 3351 (class 1259 OID 226582)
...
--
-- TOC entry 3315 (class 1259 OID 226500)
...
--
-- TOC entry 3320 (class 1259 OID 226507)
...
--
-- TOC entry 3321 (class 1259 OID 226506)
...
--
-- TOC entry 3326 (class 1259 OID 226521)
...
--
-- TOC entry 3329 (class 1259 OID 226520)
...
--
-- TOC entry 3334 (class 1259 OID 226535)
...
--
-- TOC entry 3337 (class 1259 OID 226534)
...
--
-- TOC entry 3304 (class 1259 OID 226467)
...
--
-- TOC entry 3309 (class 1259 OID 226463)
...
--
-- TOC entry 3312 (class 1259 OID 226464)
...
--
-- TOC entry 3299 (class 1259 OID 226449)
...
--
-- TOC entry 3356 (class 1259 OID 226639)
...
--
-- TOC entry 3359 (class 1259 OID 226640)
...
--
-- TOC entry 3360 (class 1259 OID 226649)
...
--
-- TOC entry 3363 (class 1259 OID 226648)
...
--
-- TOC entry 3366 (class 2606 OID 226652)
...
--
-- TOC entry 3365 (class 2606 OID 226403)
...
--
-- TOC entry 3364 (class 2606 OID 226375)
...
--
-- TOC entry 3375 (class 2606 OID 226604)
-- Name: Movement_custom_order Movement_custom_orde_product_shopping_car_eba58c2d_fk_Movement_; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Movement_custom_order"
    ADD CONSTRAINT "Movement_custom_orde_product_shopping_car_eba58c2d_fk_Movement_" FOREIGN KEY (product_shopping_car_id) REFERENCES public."Movement_product_shopping_car"(id) DEFERRABLE INITIALLY DEFERRED;


--
-- TOC entry 3376 (class 2606 OID 226609)
-- Name: Movement_custom_order Movement_custom_orde_purchase_detail_id_653c9faf_fk_Movement_; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Movement_custom_order"
    ADD CONSTRAINT "Movement_custom_orde_purchase_detail_id_653c9faf_fk_Movement_" FOREIGN KEY (purchase_detail_id) REFERENCES public."Movement_purchase_detail"(id) DEFERRABLE INITIALLY DEFERRED;


--
-- TOC entry 3377 (class 2606 OID 226599)
...
--
-- TOC entry 3378 (class 2606 OID 226594)
...
--
-- TOC entry 3381 (class 2606 OID 226583)
-- Name: Movement_product_shopping_car Movement_product_sho_product_id_f5e994bc_fk_Inventory; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Movement_product_shopping_car"
    ADD CONSTRAINT "Movement_product_sho_product_id_f5e994bc_fk_Inventory" FOREIGN KEY (product_id) REFERENCES public."Inventory_product"(id) DEFERRABLE INITIALLY DEFERRED;


--
-- TOC entry 3382 (class 2606 OID 226589)
-- Name: Movement_product_shopping_car Movement_product_sho_user_id_98450485_fk_User_user; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."Movement_product_shopping_car"
    ADD CONSTRAINT "Movement_product_sho_user_id_98450485_fk_User_user" FOREIGN KEY (user_id) REFERENCES public."User_userprofile"(identification) DEFERRABLE INITIALLY DEFERRED;


--
-- TOC entry 3379 (class 2606 OID 226571)
...
--
-- TOC entry 3380 (class 2606 OID 226576)
...
--
-- TOC entry 3370 (class 2606 OID 226501)
...
--
-- TOC entry 3371 (class 2606 OID 226510)
...
--
-- TOC entry 3372 (class 2606 OID 226515)
...
--
-- TOC entry 3374 (class 2606 OID 226529)
...
--
-- TOC entry 3373 (class 2606 OID 226524)
...
--
-- TOC entry 3369 (class 2606 OID 226458)
...
--
-- TOC entry 3368 (class 2606 OID 226453)
...
--
-- TOC entry 3367 (class 2606 OID 226444)
...
--
-- TOC entry 3383 (class 2606 OID 226629)
...
--
-- TOC entry 3384 (class 2606 OID 226634)
...
-- Completed on 2023-08-17 22:14:04
